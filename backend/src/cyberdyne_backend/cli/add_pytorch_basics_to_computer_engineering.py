"""Add the "PyTorch — Basics" course to the Computer Engineering learning
...
(``seed_pytorch``); this script

  1. creates the ``pytorch-basics`` module bundling that course
...
Safe to re-run.
    ...
    python -m cyberdyne_backend.cli.add_pytorch_basics_to_computer_engineering
...
MODULE: dict[str, Any] = {
    ...
    "icon": "🔦",
    "description": (
        "Deep learning with PyTorch: tensors, autograd, nn.Module, losses "
        "and optimizers, the training loop, Dataset/DataLoader and a "
        "complete digit classifier — one diagram and runnable examples per "
        "lesson."
    ),
    "topics": [
        "Tensors & Autograd",
...
MODULE_TRANSLATIONS: dict[str, dict[str, str]] = {
    "pt-BR": {
        "title": "PyTorch — Fundamentos",
        "description": (
            "Deep learning com PyTorch: tensores, autograd, nn.Module, "
            "funções de perda e otimizadores, o loop de treinamento, "
            "Dataset/DataLoader e um classificador de dígitos completo — um "
            "diagrama e exemplos executáveis por lição."
        ),
    },
    "es": {
        "title": "PyTorch — Fundamentos",
        "description": (
            "Deep learning con PyTorch: tensores, autograd, nn.Module, "
            "funciones de pérdida y optimizadores, el bucle de "
            "entrenamiento, Dataset/DataLoader y un clasificador de dígitos "
            "completo — un diagrama y ejemplos ejecutables por lección."
        ),
    },
    "fr": {
        "title": "PyTorch — Les bases",
        "description": (
            "Deep learning avec PyTorch : tenseurs, autograd, nn.Module, "
            "fonctions de perte et optimiseurs, la boucle d'entraînement, "
            "Dataset/DataLoader et un classifieur de chiffres complet — un "
            "diagramme et des exemples exécutables par leçon."
        ),
    },
}
...
def build_module_payload() -> dict[str, Any]:
    ...
    bundles the course this feature ships (``seed_pytorch``)."""
