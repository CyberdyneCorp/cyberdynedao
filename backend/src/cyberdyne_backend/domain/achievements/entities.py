...
ACHIEVEMENTS: tuple[AchievementDefinition, ...] = (
    AchievementDefinition(
        "first_course", "First Steps", "Complete your first course.", "🎓",
        AchievementMetric.COURSES_COMPLETED, 1,
    ),
    AchievementDefinition(
        "five_courses", "Getting Serious", "Complete five courses.", "📚",
        AchievementMetric.COURSES_COMPLETED, 5,
    ),
    AchievementDefinition(
        "ten_courses", "Dedicated Learner", "Complete ten courses.", "🏅",
        AchievementMetric.COURSES_COMPLETED, 10,
    ),
    AchievementDefinition(
        "first_quiz", "Quiz Rookie", "Pass your first quiz.", "✅",
        AchievementMetric.QUIZZES_PASSED, 1,
    ),
    AchievementDefinition(
        "quiz_master", "Quiz Master", "Pass ten quizzes.", "🧠",
        AchievementMetric.QUIZZES_PASSED, 10,
    ),
    AchievementDefinition(
        "perfectionist", "Perfectionist", "Score 100% on five quizzes.", "💯",
        AchievementMetric.PERFECT_QUIZZES, 5,
    ),
    AchievementDefinition(
        "first_certificate", "Certified", "Earn your first certificate.", "📜",
        AchievementMetric.CERTIFICATES_EARNED, 1,
    ),
    AchievementDefinition(
        "scholar", "Scholar", "Earn five certificates.", "🏆",
        AchievementMetric.CERTIFICATES_EARNED, 5,
    ),
    AchievementDefinition(
        "module_explorer", "Module Explorer", "Complete five modules.", "🧩",
        AchievementMetric.MODULES_COMPLETED, 5,
    ),
)
