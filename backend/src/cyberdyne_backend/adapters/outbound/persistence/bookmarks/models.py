...
class FavoriteRow(Base):
    ...
    __table_args__ = (UniqueConstraint("user_id", "type", "ref", name="uq_favorite_user_type_ref"),)
...
class RecentViewRow(Base):
    ...
    __table_args__ = (UniqueConstraint("user_id", "type", "ref", name="uq_recent_user_type_ref"),)
