...
export interface WindowState {
	...
	originalX?: number;
	originalY?: number;
	content: 'read' | 'shop' | 'cart' | 'investments' | 'watch' | 'listen' | 'substack' | 'contact' | 'dao' | 'products' | 'team' | 'terminal' | 'services' | 'cyberdyne' | 'matlab' | 'agent' | 'cyberflies' | 'interpreter' | 'courses' | 'admin' | 'sysadmin' | 'analytics' | 'settings';
}
